...
public class BasePage {
	...
	public String geraNomeAleatorio() {
		String[] nomes = { "Antonio", "Rafael", "Bruno", "Marcelo", "Alberto", "Pedro", "Anderson", "Airton", "Sidney",
				...
				"Isabela", "Joice", "Joseense", "Beatriz", "Laura", "Maria Luiza", "JÃºlia","Ana", "Alice", "Sofia", "Maria Eduarda", "Larissa", 
				"Mariana", "Isabela", "Camila", "Valentina", "Lara", "LetÃ­cia", "Miguel", "lucas", "Guilherme" ,"Gabriel", "Enzo", "Arthur", "Rafael", "JoÃ£o", "Gustavo", "Pedro", 
	...
	public String geraEstadoAleatorio() {
		String[] estados = { "Acre", "Alagoas", "AmapaÂ¡", "Amazonas", "Bahia", "CearaÂ¡", "Distrito Federal",
	...
	public String GeraMesorregiaoAleatorio() {
		String[] mesorregiao = { "Agreste Alagoano", "Agreste Paraibano", "Agreste Pernambucano", "Agreste Potiguar",
				...
				"Vale do Acre", "Vale do ItajiÂ­", "Vale do Mucuri", "Vale do Paraiba Paulista",
	...
	/***
	 * Clica no botÃÂ£o via comando By Ex By.xpath("campo").
	 * 
	 * @param by
	 */
	...
	public String GerarTituloAleatorio() {
		String[] Titulo = { "CNA na Escola pÃÂºblica", "CNA Go", "Don't Bee Loro", " CNA Portal Corporativo" };
